...
class Fairmq(CMakePackage):
    ...
    version('1.4.32', tag='v1.4.32', commit='bbc1dd460035c0ffe22aa9d0c506d6e59b333315', submodules=True, no_cache=True)
    version('1.4.31', tag='v1.4.31', commit='93dff3c5a7dec961c4e96fd3f8ff91d5ef8caeb1', submodules=True, no_cache=True)
